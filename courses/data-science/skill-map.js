...
(function (global) {
  ...
  { id: "tableau", label: "Tableau", category: "BI", members: ["tableau-fields", "tableau-shelves", "tableau-chart-choice", "tableau-table-calcs", "tableau-analytics-pane", "tableau-calc-fields", "tableau-lod"] },
  { id: "powerbi", label: "Power BI", category: "BI", members: ["powerbi-fields", "powerbi-visuals", "powerbi-data-cleaning", "powerbi-combine-reshape", "powerbi-data-modeling", "powerbi-dax"] },
  { id: "dashboard-design", label: "Dashboard Design", category: "BI", members: ["tableau-dashboard-design", "tableau-dashboard-actions", "powerbi-report-dashboard", "powerbi-report-interactivity", "powerbi-service-governance"] },
