...
(function (global) {
  ...
  const MODULES = [
    ...
    { id: 5, file: "module-05.html", stage: 2, title: "JavaScript: logic you can defend", minutes: 80,
      loop: ["specify", "inspect", "test", "debug", "review"],
      teaser: "Predict, catch the agent's filter, then write it yourself. AI improves only after you can defend the result." },
