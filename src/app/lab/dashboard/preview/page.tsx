...
import { TeamMap } from "./_halo/TeamMap";
import { Eyebrow } from "./_halo/ui";
import { activity, agency, mapAgents, needsYou, stats, type DotTone } from "./sample-data";
...
export default function DashboardPreviewOverview() {
  return (
    <main className={`${shell.main} ${s.main}`}>
      ...
      <header className={s.header}>
        <div className={s.greeting}>
          ...
          <p className={s.subtitle}>3 agents active · 3 items need you</p>
        </div>
        <div className={s.headerActions}>
          <label className={s.search}>
            <Icon name="search" size={18} />
            <span className={tokens.srOnly}>Ask your team</span>
      ...
      <div className={s.body}>
        <section className={`${tokens.dots} ${s.mapPanel}`} aria-label="Team map">
