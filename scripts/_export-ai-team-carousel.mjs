// Renders insta/ai-team-carousel/slide-*.html to PNG using the project's
// established plain-HTML + Puppeteer export method (see memory:
// social-image-export-method). Standalone script scoped to just this new
// folder so it doesn't re-render every other insta/ ad folder.
...
const dir = path.join(scriptDir, "..", "insta", "ai-team-carousel");
